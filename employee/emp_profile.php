	...
	<div class="row">
      ...
      <div class="col-md-4">
        <div class="text-center">
          <img src="emp_images/<?php echo $employeeImage; ?>" class="img-circle" alt="<?php echo $employeeImage; ?>" width="400" height="400" >
        </div>
      </div>
...
<?php } ?>
          <div class="form-group">
            ...
            <div class="col-md-8">
              <a href="index.php"><button type="button" id="submit" name="submit" class="btn btn-primary">Go Back</button></a>
              <span></span>
