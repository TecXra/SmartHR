...
<div class="container-fluid">
    ...
    <li><a href='emp_leave_deny'><input type='button' value='Deny'data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a></li>	
						</ul>
					</div>
					<div class = "col-md-6">
						<h1>Employee's Pending Leaves</h1>
					</div>
				</div>
      <hr/>
<?php
				...
				if(($djune <= $tdy)&&($ddec >= $tdy)):
					...
					$cya = date("Y-m-d",$cyaa);
						...
						$sql = "SELECT * FROM employee, leaves, admin_approve
									...
									AND admin_approve.admin_approve = '1'
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
								...
								<td>
									<a href='approval.php?id=<?php echo $rec['leave_id'];?>'><input type='button' value='View Details' data-toggle="tooltip" data-placement="top" title="View to Approve" class='btn btn-info'/></a>
								</td>
						</tr>
					</tbody>
					<?php
